...
#include "velodyne_cpp/PacketDecoder.h"
...
std::deque<PacketDecoder::HDLFrame> PacketDecoder::GetFrames() { return _frames; }

void PacketDecoder::ClearFrames() { _frames.clear(); }
